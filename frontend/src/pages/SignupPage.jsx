...
import { Map, Eye, EyeOff, CheckCircle } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4" style={{ overflow: 'auto', height: '100vh' }}>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-emerald-600/8 rounded-full blur-[120px]" />
        </div>
